...
extern int ACTIONS_NUMBER; // GLOBAL variable (retrieved from the user)
...
void Print_Action(const int action);
...
Node* BreadthFirstSearch(Node *const root);
void Show_Solution_Path(Node *const goal);

// ======= Functions required for algorithms like GENERALIZED A* etc. =======
